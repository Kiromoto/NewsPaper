...
def notify_managers_appointment(sender, instance, created, **kwargs):
    ...
    try:
        ...
        print('Ошибка: не удалось получить категорию опубликованной новости.')
    else:
        subject = f'Опубликована новая статья в вашей любимой категории "{category_name}" на NewsPaper.'
        ...
        print('Создание новости выполнено.')
